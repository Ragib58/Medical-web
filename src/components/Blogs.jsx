    ...
    <div className='min-h-screen flex flex-col justify-center lg:px-32 px-5 pt-24'>
        <div className='flex flex-col items-center lg:flex-row justify-between'>
            <div>
                <h1 className='text-4xl font-semibold text-center lg:text-start'>Latest Post</h1>
                  <p className='mt-2 text-center lg:text-start'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis, ipsa!</p>
            </div>
        ...
        <div className='my-8'>
            <div className='flex flex-wrap justify-center gap-5'>
               <BlogCard img={img1} headlines="Unravelling the Mysteries of Sleep"/>
